                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img} />
                                    <h2 className="font-semibold my-4 text-2xl text-center">Personalized AI Conversations:</h2>
                                    <p className="text-md font-medium">
                                    Our advanced AI technology is fine-tuned with messages, emails, and other communications from your loved ones to create a unique, personalized conversational experience.                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img2} />
                                    <h2 className="font-semibold my-4 text-2xl text-center">Retrieval-Augmented Generation (RAG):</h2>
                                    <p className="text-md font-medium">
                                    We use Retrieval-Augmented Generation to enhance the authenticity of interactions, ensuring the AI responds with contextually relevant and meaningful replies.                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                <div className="m-2 text-justify text-sm">
                                    ...
                                    <h2 className="font-semibold my-4 text-2xl text-center ">Privacy and Ethics:</h2>
                                    <p className="text-md font-medium">
                                    Your privacy is our top priority. We follow strict ethical guidelines and ensure all data is used responsibly and with full consent.                                    </p>
                                </div>
                            </div>
                ...
                <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6">
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="zoom-out">
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            font-bold"><span className='font-black'>Authentic </span>Conversations:</h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
                                Experience conversations that feel real and emotionally resonant, bringing back the unique voice and personality of your loved ones.                                </p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            <div className='text-blue-900 mb-4'>
                            ...
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
                                Our platform is designed to be a safe space for remembering and reconnecting, with strict adherence to privacy and ethical standards.                                    </p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            <div className='text-blue-900 mb-4'>
